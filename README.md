...
Este diretório reúne as **atividades avaliativas** da disciplina de **Algoritmos e Pensamento Computacional**. Cada atividade fica em sua própria subpasta, com código-fonte e README explicando o que foi feito, as funções implementadas e como executar.

### Atividades

| Pasta | Atividade | Linguagem | Descrição |
|---|---|:---:|---|
...
This directory gathers the **graded assignments** for the **Algorithms and Computational Thinking** course. Each assignment lives in its own subfolder, with source code and a README explaining what was done, the implemented functions, and how to run it.

### Assignments

| Folder | Assignment | Language | Description |
|---|---|:---:|---|
