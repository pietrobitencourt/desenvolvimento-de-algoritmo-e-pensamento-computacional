...
void calcularRaizes(void);
void calcularLogaritmo(void);
void calcularValorAbsoluto(void);
void converterAngulo(void);
void calcularHipotenusa(void);
...
int main() {
    ...
    do {
        ...
        printf("1  - IMC\n");
        printf("2  - Area (quadrado, triangulo, circulo, losango, retangulo)\n");
        ...
        printf("14 - Raizes (quadrada e cubica)\n");
        printf("15 - Logaritmo (natural e base 10)\n");
        printf("16 - Valor absoluto\n");
        printf("17 - Conversao de angulo (graus <-> radianos)\n");
...
void calcularArea(void) {
    ...
    do {
        printf("\nEscolha a figura geometrica:\n [1] Quadrado | [2] Triangulo | [3] Circulo | [4] Losango | [5] Retangulo | [0] para sair\n");
        printf("Opcao: ");
        ...
        switch (opcaoArea) {
            ...
            case 4:
                ...
                break;
            case 5:
                printf("Digite a base do retangulo (em u.m): ");
                scanf("%lf", &baseRetangulo);

                printf("Digite a altura do retangulo (em u.m): ");
                scanf("%lf", &alturaRetangulo);

                area = baseRetangulo * alturaRetangulo;
                printf("A area do retangulo eh: %.2lf u.m^2\n", area);
                break;
            case 0:
...
void calcularRaizes(void) {
    int opcaoRaiz;
    double valor, resultadoRaiz;

    do {
        printf("\n===Raizes===\n");
        printf("[1] Raiz quadrada [2] Raiz cubica [0] para sair\n");
        printf("Opcao: ");

        if (!lerInteiro(&opcaoRaiz)) {
            printf("Entrada invalida! Digite um numero.\n");
            continue;
        }
        ...
        switch (opcaoRaiz) {
            case 1:
                ...
                resultadoRaiz = sqrt(valor);
                printf("Raiz quadrada de %.2lf eh: %.4lf\n", valor, resultadoRaiz);
                break;
            ...
            case 2:
                ...
                resultadoRaiz = cbrt(valor);
                printf("Raiz cubica de %.2lf eh: %.4lf\n", valor, resultadoRaiz);
                break;
...
void calcularLogaritmo(void) {
    int opcaoLog;
    double valor, resultadoLog;

    do {
        printf("\n===Logaritmo===\n");
        printf("[1] Logaritmo natural (ln) [2] Logaritmo base 10 [0] para sair\n");
        printf("Opcao: ");

        if (!lerInteiro(&opcaoLog)) {
            printf("Entrada invalida! Digite um numero.\n");
            continue;
        }
        ...
        switch (opcaoLog) {
            case 1:
                ...
                if (valor <= 0) {
                    printf("Erro: logaritmo so existe para valores maiores que zero.\n");
                    break;
                }

                resultadoLog = log(valor);
                printf("Logaritmo natural de %.2lf eh: %.4lf\n", valor, resultadoLog);
                break;
            ...
            case 2:
                ...
                resultadoLog = log10(valor);
                printf("Logaritmo base 10 de %.2lf eh: %.4lf\n", valor, resultadoLog);
                break;
...
void calcularValorAbsoluto(void) {
    double valor, resultadoAbs;

    printf("Digite o valor: ");
    scanf("%lf", &valor);

    resultadoAbs = fabs(valor);
    printf("O valor absoluto de %.2lf eh: %.2lf\n", valor, resultadoAbs);
}

void converterAngulo(void) {
    int opcaoAngulo;
    double angulo, resultadoAngulo;

    do {
        printf("\n===Conversao de Angulo===\n");
        printf("[1] Graus -> Radianos [2] Radianos -> Graus [0] para sair\n");
        printf("Opcao: ");

        if (!lerInteiro(&opcaoAngulo)) {
            printf("Entrada invalida! Digite um numero.\n");
            continue;
        }
        ...
        switch (opcaoAngulo) {
            case 1:
                ...
                resultadoAngulo = angulo * (PI / 180.0);
                printf("%.2lf graus equivalem a %.4lf radianos\n", angulo, resultadoAngulo);
                break;
            ...
            case 2:
                ...
                resultadoAngulo = angulo * (180.0 / PI);
                printf("%.4lf radianos equivalem a %.2lf graus\n", angulo, resultadoAngulo);
                break;

            case 0:
                printf("\nSaindo da conversao de angulo...\n");
                break;
